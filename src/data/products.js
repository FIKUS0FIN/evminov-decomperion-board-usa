...
export const products = [
  ...
  // 8. Padded Foot Sleeves for Carriage Handles
  {
    ...
    category: 'accessory',
    name: 'Carriage Handle Replacement Comfort Sleeves (Pair)',
    ukrName: 'Змінні м\'які накладки на ручки каретки (пара)',
    badge: 'Carriage Grip & Reverse Inversion Cushion',
    subtitle: 'Original high-density contoured foam replacement sleeves that slide directly over carriage handles in seconds. Provides ergonomic grip cushioning for hands and cushions ankles and shins during reverse spinal traction.',
    keyFeature: 'Original contoured high-density foam replacement sleeves for comfortable hand grip and pain-free reverse spinal decompression.',
    basePrice: 39,
    fastPrice: 49,
    rating: 4.9,
    reviewsCount: 280,
    ...
    galleryImages: [
      ...
      { url: '/images/authentic/hero-carriage-traction-detail.jpg', label: 'Hand Grip Traction' },
      { url: '/images/authentic/exercise-reverse-traction.jpg', label: 'Reverse Leg Traction' },
      { url: '/images/accessories/soft-foot-attachments-carriage.jpg', label: 'Carriage Assembly' }
    ],
    popular: false,
  },
];
